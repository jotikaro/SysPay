...
<form method="post" action="<?php echo base_url(); ?>admin/simpan_spbu" name="tes">
<table>
<tr>
	<td width="180">Nama SPBU</td>
	<td width="50">:</td>	
	<td><input type="text" name="nama" placeholder='Nama SPBU' size="50" class="input-read-only" />	</td>
</tr>
<tr>
	<td width="180">Alamat SPBU</td>
	<td width="50">:</td>	
	<td><input type="text" name="alamat" placeholder='Alamat SPBU' size="50" class="input-read-only" />	</td>
</tr>
<tr>
	<td width="180">Email SPBU</td>
	<td width="50">:</td>	
	<td><input type="text" name="email" placeholder='Email SPBU' size="50" class="input-read-only" />	</td>
</tr>
<tr>
<td width="180"></td>
<td width="50"></td>
