...
<div id="container">
	<h1>Daftar Armada- Sistem Informasi Aman Transport</h1>
	...
	<div id="body">
		...
		<td colspan="13" align="center" bgcolor="#fff" style="text-transform:uppercase;"><strong>Daftar Armada</strong></td>
		</tr>
		<th align="center">No.</th>
		<th align="center">Nomor Polisi</th>
		<th align="center">Kapasitas</th>
		<th align="center">Merk</th>
		<th align="center">Tipe</th>
		<th align="center" colspan="2" width="200">
		<?php
		echo '<a href="'.base_url().'admin/tambah_armada" rel="example_group" class="link" style="float:left;">Input Armada</a>';
		?>
		</th>
		</tr>
...
function Tampilkan_Mata_Kuliah($jdwl)
{
	...
	foreach ($jdwl->result_array() as $value) 
	{
				...
				echo '<td align="center">'.$value['kapasitas'].'</td>';
				echo '<td align="center">'.$value['merk'].'</td>';
				echo '<td align="center">'.$value['tipe'].'</td>';
				echo '<td align="center">
				<a href="'.base_url().'admin/edit_armada/'.$value['id'].'" rel="example_group" class="link" style="float:left;">Edit</a>
				</td>';
				echo '<td align="center">
				<a href="'.base_url().'admin/hapus_armada/'.$value['id'].'"
