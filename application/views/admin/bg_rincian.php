...
<div id="container">
	<h1>Daftar Rincian- Sistem Informasi Aman Transport</h1>
	...
	<div id="body">
		...
		<td colspan="13" align="center" bgcolor="#fff" style="text-transform:uppercase;"><strong>Daftar Rincian Biaya</strong></td>
		</tr>
		<th align="center">No.</th>
		<th align="center">Nama Biaya</th>
		<th align="center">Jumlah Biaya</th>
		<th align="center">Bagian Dari Jenis Biaya</th>
		<th align="center" colspan="2" width="200">
		<?php
		echo '<a href="'.base_url().'admin/tambah_rincian" rel="example_group" class="link" style="float:left;">Input Rincian Biaya Baru</a>';
		?>
		</th>
		</tr>
			<?php Tampilkan_Mata_Kuliah($order); ?>
		</table>
	</div>
...
function Tampilkan_Mata_Kuliah($jdwl)
{
	...
	foreach ($jdwl->result_array() as $value) 
	{
				...
				echo '<td align="center">'.$value['nama_biaya'].'</td>';
				echo '<td align="center">'.$value['jumlah'].'</td>';
				echo '<td align="center">'.$value['kodeBiaya'].'</td>';
				echo '<td align="center">
				<a href="'.base_url().'admin/edit_rincian/'.$value['id_rincian'].'" rel="example_group" class="link" style="float:left;">Edit</a>
				</td>';
				echo '<td align="center">
				<a href="'.base_url().'admin/hapus_rincian/'.$value['id_rincian'].'"
